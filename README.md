...
> **Status:** architecture-validation phase. The v1 SDK API surface will be documented publicly closer to v1.0 and is not yet implemented here. Do not consume any package from this repository until v0.1.0.
...
| `sdks/android/` | Gradle module, ergonomic wrapper around UniFFI-generated Kotlin. |
...
| `examples/<platform>-demo/` | Source-linked sample apps (native iOS, native Android). Inner-loop development. |
...
| `docs/` | Public-visible documentation. |
